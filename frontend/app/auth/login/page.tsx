...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow">
      <h1 className="text-2xl font-bold text-vault-900">Login</h1>
      <p className="mt-1 text-sm text-slate-600">
        Seed users: alice@example.com / password123 (seller), bob@example.com /
        password123 (buyer)
      </p>
      ...
      <p className="mt-4 text-center text-sm text-slate-600">
        No account?{" "}
        <Link href="/auth/register" className="text-vault-700 underline">
          Register
        </Link>
      </p>
    </div>
